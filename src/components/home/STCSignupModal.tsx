...
function STCForm({ setOpen }: { setOpen: (open: boolean) => void }) {
    ...
    return (
        <div className="flex w-full flex-col items-center">
            ...
            >
                <p className="relative left-5 top-4 self-start rounded-bl-[50px] rounded-tl-[50px] rounded-tr-[50px] bg-[#FBD24D] px-[17.5px] py-1 text-black font-bold">
                    Dane rodzica/opiekuna
                </p>
                <div className="relative flex w-full flex-col gap-5 rounded-[15px] border-[2px] border-[#FBD24D] p-5 bg-black/40">
                    <Input
                        name="name_stc"
