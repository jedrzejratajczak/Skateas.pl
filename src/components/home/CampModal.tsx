        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 p-2 backdrop-blur-md sm:p-4">
            <div className="relative flex h-full max-h-[95vh] w-full max-w-5xl flex-col items-center justify-between rounded-3xl bg-[#1a1a1a] p-4 shadow-2xl sm:p-8">
                ...
                <div className="relative flex w-full flex-1 items-center justify-center overflow-hidden">
                    ...
                    <button
                        onClick={prevSlide}
                        className="absolute left-0 z-10 hidden h-12 w-12 items-center justify-center rounded-full bg-black/50 text-[#FBD24D] transition-all hover:bg-black/80 hover:scale-110 active:scale-95 lg:flex"
                    ...
                    <button
                        onClick={nextSlide}
                        className="absolute right-0 z-10 hidden h-12 w-12 items-center justify-center rounded-full bg-black/50 text-[#FBD24D] transition-all hover:bg-black/80 hover:scale-110 active:scale-95 lg:flex"
                        aria-label="Następny"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
