...
export function Dropdown({
  ...
  return (
    <div className="relative mx-auto md:max-w-[70%] lg:max-w-[60%] xl:max-w-[50%] 2xl:max-w-[900px]">
      ...
      <div
        className={`overflow-hidden rounded-b-[20px] text-white transition-all lg:rounded-b-[32px]  lg:text-xl ${border} ${open ? 'max-h-[150px] border px-4 py-3 delay-100' : 'max-h-0'}`}
      >
        {text}
      </div>
    </div>
